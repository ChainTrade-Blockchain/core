...
import (
	...
	erc20v2 "github.com/ChainTrade-Blockchain/core/x/erc20/v2"
	"github.com/ChainTrade-Blockchain/core/x/feemarket"
	...
	transferv2 "github.com/ChainTrade-Blockchain/core/x/ibc/transfer/v2"
	"github.com/ChainTrade-Blockchain/core/x/precisebank"
	precisebankkeeper "github.com/ChainTrade-Blockchain/core/x/precisebank/keeper"
	precisebanktypes "github.com/ChainTrade-Blockchain/core/x/precisebank/types"
	"github.com/ChainTrade-Blockchain/core/x/vm"
...
var (
	_ runtime.AppI            = (*CVMD)(nil)
	_ servertypes.Application = (*CVMD)(nil)
	_ ibctesting.TestingApp   = (*CVMD)(nil)
)

// CVMD extends an ABCI application, but with most of its parameters exported.
type CVMD struct {
	*baseapp.BaseApp
...
// NewExampleApp returns a reference to an initialized CVMD.
func NewExampleApp(
	logger log.Logger,
	db dbm.DB,
...
func (app *CVMD) setAnteHandler(txConfig client.TxConfig, maxGasWanted uint64) {
...
func (app *CVMD) Name() string { return app.BaseApp.Name() }

// BeginBlocker application updates every begin block
func (app *CVMD) BeginBlocker(ctx sdk.Context) (sdk.BeginBlock, error) {
	return app.ModuleManager.BeginBlock(ctx)
}

// EndBlocker application updates every end block
func (app *CVMD) EndBlocker(ctx sdk.Context) (sdk.EndBlock, error) {
	return app.ModuleManager.EndBlock(ctx)
}

func (app *CVMD) FinalizeBlock(req *abci.RequestFinalizeBlock) (res *abci.ResponseFinalizeBlock, err error) {
	return app.BaseApp.FinalizeBlock(req)
}

func (app *CVMD) Configurator() module.Configurator {
	return app.configurator
}

// InitChainer application update at chain initialization
func (app *CVMD) InitChainer(ctx sdk.Context, req *abci.RequestInitChain) (*abci.ResponseInitChain, error) {
...
func (app *CVMD) PreBlocker(ctx sdk.Context, _ *abci.RequestFinalizeBlock) (*sdk.ResponsePreBlock, error) {
	return app.ModuleManager.PreBlock(ctx)
}

// LoadHeight loads a particular height
func (app *CVMD) LoadHeight(height int64) error {
	return app.LoadVersion(height)
}

// LegacyAmino returns CVMD's amino codec.
//
// NOTE: This is solely to be used for testing purposes as it may be desirable
// for modules to register their own custom testing types.
func (app *CVMD) LegacyAmino() *codec.LegacyAmino {
	return app.legacyAmino
}

// AppCodec returns CVMD's app codec.
//
// NOTE: This is solely to be used for testing purposes as it may be desirable
// for modules to register their own custom testing types.
func (app *CVMD) AppCodec() codec.Codec {
	return app.appCodec
}

// InterfaceRegistry returns CVMD's InterfaceRegistry
func (app *CVMD) InterfaceRegistry() types.InterfaceRegistry {
	return app.interfaceRegistry
}

// TxConfig returns CVMD's TxConfig
func (app *CVMD) TxConfig() client.TxConfig {
	return app.txConfig
}

// DefaultGenesis returns a default genesis from the registered AppModuleBasic's.
func (app *CVMD) DefaultGenesis() map[string]json.RawMessage {
...
func (app *CVMD) GetKey(storeKey string) *storetypes.KVStoreKey {
...
//
// NOTE: This is solely to be used for testing purposes.
func (app *CVMD) GetTKey(storeKey string) *storetypes.TransientStoreKey {
...
func (app *CVMD) GetMemKey(storeKey string) *storetypes.MemoryStoreKey {
...
//
// NOTE: This is solely to be used for testing purposes.
func (app *CVMD) GetSubspace(moduleName string) paramstypes.Subspace {
	subspace, _ := app.ParamsKeeper.GetSubspace(moduleName)
	return subspace
}

// SimulationManager implements the SimulationApp interface
func (app *CVMD) SimulationManager() *module.SimulationManager {
	return app.sm
}

// RegisterAPIRoutes registers all application module routes with the provided
// API server.
func (app *CVMD) RegisterAPIRoutes(apiSvr *api.Server, apiConfig config.APIConfig) {
...
func (app *CVMD) RegisterTxService(clientCtx client.Context) {
	authtx.RegisterTxService(app.GRPCQueryRouter(), clientCtx, app.Simulate, app.interfaceRegistry)
}

// RegisterTendermintService implements the Application.RegisterTendermintService method.
func (app *CVMD) RegisterTendermintService(clientCtx client.Context) {
...
func (app *CVMD) RegisterNodeService(clientCtx client.Context, cfg config.Config) {
...
func (app *CVMD) GetBaseApp() *baseapp.BaseApp {
	return app.BaseApp
}

// GetStakingKeeperSDK implements the TestingApp interface.
func (app *CVMD) GetStakingKeeperSDK() stakingkeeper.Keeper {
	return *app.StakingKeeper
}

// GetIBCKeeper implements the TestingApp interface.
func (app *CVMD) GetIBCKeeper() *ibckeeper.Keeper {
	return app.IBCKeeper
}

func (app *CVMD) GetEVMKeeper() *evmkeeper.Keeper {
	return app.EVMKeeper
}

func (app *CVMD) GetErc20Keeper() *erc20keeper.Keeper {
	return &app.Erc20Keeper
}

func (app *CVMD) SetErc20Keeper(erc20Keeper erc20keeper.Keeper) {
	app.Erc20Keeper = erc20Keeper
}

func (app *CVMD) GetGovKeeper() govkeeper.Keeper {
	return app.GovKeeper
}

func (app *CVMD) GetEvidenceKeeper() *evidencekeeper.Keeper {
	return &app.EvidenceKeeper
}

func (app *CVMD) GetSlashingKeeper() slashingkeeper.Keeper {
	return app.SlashingKeeper
}

func (app *CVMD) GetBankKeeper() bankkeeper.Keeper {
	return app.BankKeeper
}

func (app *CVMD) GetFeeMarketKeeper() *feemarketkeeper.Keeper {
	return &app.FeeMarketKeeper
}

func (app *CVMD) GetFeeGrantKeeper() feegrantkeeper.Keeper {
	return app.FeeGrantKeeper
}

func (app *CVMD) GetAccountKeeper() authkeeper.AccountKeeper {
	return app.AccountKeeper
}

func (app *CVMD) GetAuthzKeeper() authzkeeper.Keeper {
	return app.AuthzKeeper
}

func (app *CVMD) GetDistrKeeper() distrkeeper.Keeper {
	return app.DistrKeeper
}

func (app *CVMD) GetStakingKeeper() *stakingkeeper.Keeper {
	return app.StakingKeeper
}

func (app *CVMD) GetMintKeeper() mintkeeper.Keeper {
	return app.MintKeeper
}

func (app *CVMD) GetPreciseBankKeeper() *precisebankkeeper.Keeper {
	return &app.PreciseBankKeeper
}

func (app *CVMD) GetCallbackKeeper() ibccallbackskeeper.ContractKeeper {
	return app.CallbackKeeper
}

func (app *CVMD) GetTransferKeeper() transferkeeper.Keeper {
	return app.TransferKeeper
}

func (app *CVMD) SetTransferKeeper(transferKeeper transferkeeper.Keeper) {
	app.TransferKeeper = transferKeeper
}

func (app *CVMD) GetAnteHandler() sdk.AnteHandler {
	return app.BaseApp.AnteHandler()
}

// GetTxConfig implements the TestingApp interface.
func (app *CVMD) GetTxConfig() client.TxConfig {
	return app.txConfig
}

// AutoCliOpts returns the autocli options for the app.
func (app *CVMD) AutoCliOpts() autocli.AppOptions {
