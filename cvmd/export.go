...
// file.
func (app *CVMD) ExportAppStateAndValidators(forZeroHeight bool, jailAllowedAddrs []string, modulesToExport []string) (servertypes.ExportedApp, error) {
...
func (app *CVMD) prepForZeroHeightGenesis(ctx sdk.Context, jailAllowedAddrs []string) error {
